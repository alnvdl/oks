...
class OperationsTest(OksTestCase):
    def testInvalidCompanyOnInsert(self):
        ...
        self.assertRaises(
            oks.InvalidCompanyError,
            self.db.toggle_status,
            oks.OPERATION,
            operation_row_id,
        )
    ...
    def testProductionOperationStatusChange(self):
        ...
        operation = Operation(
            company=COMPANY_1, type_=oks.TYPE_PRODUCTION_OPERATION
        )

        production_item = ProductionItem(
            name=PRODUCTION_ITEM_1,
            quantity=10,
