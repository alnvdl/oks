...
class CompactCompaniesReport(Report):
    ...
    OPTIONS = [
        ("customers", oks.REPORT_OPTION_BOOL, "Incluir clientes", True),
        ("suppliers", oks.REPORT_OPTION_BOOL, "Incluir fornecedores", True),
        ("city", oks.REPORT_OPTION_TEXT, "Filtrar por cidade", ""),
    ]
...
class MostImportantCompanies(Report):
    ...
    DESCRIPTION = (
        "Listagem de empresas ordenedadas pelos valores consumidos "
        "em um dado período."
    )
